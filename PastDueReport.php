...
<h1 style="text-align:center;">  Book Past Due Report </h1>

<h2 style="text-align:center;"> Report Results: Book Past Due Report </h2>
...
$query = "select Title,Author,Publisher,DueDate,Name,PhoneNumber,Email
from BOOK b, ORDER_TBL ot, PATRON p
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr><th>Book Title</th> &emsp;<th>Book Author</th> &emsp;<th>Publisher Name</th> &emsp;<th>Due Date </th>   &emsp;<th>Customer Name </th>   &emsp;<th>Phone Number  </th>  &emsp;<th>Email </th>   ";
    echo "</div>";
